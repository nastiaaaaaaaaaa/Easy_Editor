...
btn_add_border = QPushButton("Додати рамку")
...
# -                                                                   [ Завдання №2 ]
win.setStyleSheet("background-color:#17c272")
btn_file.setStyleSheet("background-color:#591bb5;color:white")
btn_black_white.setStyleSheet("background-color:black;color:white")
btn_left.setStyleSheet("background-color:#30d150")
btn_right.setStyleSheet("background-color:#f5811b;color:white")
btn_blur.setStyleSheet("background-color:#cc0a1a")
btn_sharp.setStyleSheet("background-color:#e64012;color:white")
btn_mirror.setStyleSheet("background-color:#2d0e9c;color:white")
btn_add_border.setStyleSheet("background-color:#044dba;color:white")
list_file.setStyleSheet("background-color:white")
...
btn_add_border.clicked.connect(workimage.do_add_border)
